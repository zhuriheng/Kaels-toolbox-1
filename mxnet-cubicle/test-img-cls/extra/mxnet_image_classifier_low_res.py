    ...
    while(image_list):
        ...
        for _ in xrange(batch_size):
            if not image_list:    # list is empty
                ...
                buffer_image_list.append(str(args['--data-prefix']) + image_list.pop(0))
            else:
...
def test2():
    ...
    '''
    image_list = ['test1.jpg','test2.jpg','test1.jpg','test2.jpg','test1.jpg','test2.jpg','test1.jpg','test2.jpg','test1.jpg','test2.jpg']
    model = net_init()
